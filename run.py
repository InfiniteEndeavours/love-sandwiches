...
def validate_data(values):
    ...
    """
    try:
        # For each value in values list, convert to integer.
        # If it cannot be converted will raise ValueError in except clause.
...
def update_worksheet(data, sheet_name):
    """
    Updates worksheet with a new row of data (integers).
    """
...
def get_last_5_entries_sales():
    ...
    for ind in range(1, 7):
        ...
        # appends last 5 entries of each column to columns list
...
def calculate_stock_data(data):
    ...
    new_stock_data = []
    for itm in data:
        # Converts each list in data into list of integers
        int_column = [int(num) for num in itm]
...
def get_stock_values(data):
    ...
    """
    headings = SHEET.worksheet('stock').get_values()[0]
...
stock_values = get_stock_values(stock_data_output)
print(stock_values)
